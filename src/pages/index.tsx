...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`ROQ HR Management System v2`}</title>

        <meta
          name="description"
          content="Empower your workforce with ROQ HR Management System v2 - Your one-stop solution for employee data, payroll, time tracking, vacation management, and performance evaluations."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517048676732-d65bc937f952?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxIUiUyMG1hbmFnZW1lbnR8ZW58MHx8fHwxNjkxMTI2MjAzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`ROQ HR Management System v2`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower your workforce with ROQ HR Management System v2 - Your one-stop solution for employee data, payroll, time tracking, vacation management, and performance evaluations.`}
            </Text>
            <Box
